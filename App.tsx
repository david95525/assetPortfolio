  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="PortfolioOverview">
        <Stack.Screen name="PortfolioOverview" component={PortfolioOverview} options={{ title: "投資組合總覽" }} />
        <Stack.Screen name="AddInvestment" component={AddInvestment} options={{ title: "新增投資紀錄" }} />
        <Stack.Screen name="AssetAllocation" component={AssetAllocation} options={{ title: "資產配置" }} />
        {/* <Stack.Screen
          name="AssetDetail"
